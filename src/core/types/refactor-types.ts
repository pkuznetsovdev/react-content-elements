...
import {ContentElementTag, ContentElementModifiers, ContentElementName} from "../content-element";


export interface CEHTMLProps1<TagName extends keyof HTMLElementTagNameMap = any> extends Omit<React.HTMLProps<unknown>, 'content'> {
}
...
interface ContentElementTemplateProps1 {
    ...
    list: CEHTMLProps1<'ul' | 'ol' | 'dl'> & Partial<{
        itemKey: string;
...
export interface ContentElementConfig1<ElementName extends ContentElementName> {
    ...
    config?: Omit<ContentElementConfig1<ElementName>, 'config'> & ContentElementTemplateProps1[ElementName];
    // move
    contentElementName?: ElementName;
}

export type ContentElementProps1<ElementName extends ContentElementName> = ContentElementTemplateProps1[ElementName] & ContentElementConfig1<ElementName>;